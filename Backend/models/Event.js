...
const eventSchema = new mongoose.Schema({
  ...
  date_to: { type: Date },
  location: { type: String, required: true }, // e.g., city or venue
  ...
  // Google Maps fields for geographic location
  geo_location: {
    latitude: { type: Number },  // Store latitude for Google Maps integration
    longitude: { type: Number }, // Store longitude for Google Maps integration
  },
